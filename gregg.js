...
GreggE.prototype.setPaths = function() {
  ...
  switch (tail_ + "_" + _head) {
    ...
    case "NE_E":
      this.dp = p(0, 0);
      this.paths = ["m 0, 0 c -0.7073,-0.851 0.7087,-2.124 1.2127,-1.053 0.1928,0.41 -0.7141,0.801 -1.2127,1.053"];
      return;
  ...
  switch (name_) {
    ...
    case "GreggD":
      this.dp = p(0, 0);
      this.paths = ["m 0, 0 c 0.3243601,1.0577029 2.1653951,0.5704908 1.5453342,-0.4377786 -0.2372565,-0.3857984 -1.0610163,0.1588449 -1.5453342,0.4377786"]
      return;
