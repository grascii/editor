...
WasedaSa.prototype.getFilteredPrevTailType = function() {
  return this.getPrevTailType().replace(/^(?:ELCL4|NELCL4|ECL4|SERCL4|ECL|NE|NEP|E|SEL4|EP|ECL4P|NECLP)$/, "R");
};
...
WasedaShi.prototype.setPaths = function() {
  ...
  console.log(this.getFilteredPrevTailType());
...
WasedaCha.prototype.getFilteredPrevTailType = function() {
  return this.getPrevTailType().replace(/^(?:E)$/, "R");
};
...
WasedaKyo = function() { WasedaChar.call(this, "WasedaKyo", "きょ", "SL8OL4", "SL", "SLOL", "black", false, p(1.0, -4.0), 4); };
