...
GreggA.prototype.setPaths = function() {
  ...
  switch (tail_ + "_" + _head) {
    case "E_NE":
      this.dp = p(0, 0);
      this.paths = ["m 0 0 c 0.61007 0.05428 1.18882 0.454549 1.21785 0.97343 c 0.05834 1.04273 -1.18163 2.05838 -2.21388 2.21699 c -0.520387 0.079963 -1.31698 -0.211121 -1.40015 -0.731006 c -0.180801 -1.1302 1.19552 -1.76622 2.39617 -2.45942"];
      return;
...
WasedaRi.prototype.setPaths = function() {
  ...
  switch (_model.replace(/[CO].*/, "")) {
    case "NEL8":
      this.dp = p(4.2901, 5.3138);
      this.paths = ["m 0 0 c 1.8842 1.3193 4.34324 3.76703 4.3209 5.734 c -0.01206 1.06203 -0.873463 0.79102 -1.07754 0.458303 c -0.238164 -0.388292 0.271863 -0.448979 1.04674 -0.878503"];
      return;
  }
