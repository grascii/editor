...
WasedaTa.prototype.toReverse = function() {
  return /^(SWR|SW|SR|S|SER|SWRCR|SCR)$/.test(this.getPrevTailType());
};
...
WasedaSa.prototype.getFilteredPrevTailType = function() {
  return this.getPrevTailType().replace(/^(?:ELCL4|NELCL4|ECL4|SERCL4|ECL|NE|NEP|E|SEL4|EP|ECL4P|NECLP|NELCL8)$/, "R");
};
...
WasedaKi.prototype.setPaths = function() {
  ...
  switch (_head) {
    ...
    case "SW":
      this.dp = p(6.8, 0);
      this.paths = ["m 0 0 h 7.5 c 0.58408 0 0.670126 -1.03055 0.105086 -1.10475 c -0.46945 -0.0617 -0.622638 0.6752 -0.805086 1.10475"];
      return;
...
WasedaTo.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(?:SELCL4|E|EP|ER|ER4|ERCR|ERCR4|EL|ECL|NELCL|NEL|NE|SELCL|NEF|ELP|ELCLP|NELP|NELCL4)$/, "R");
};
...
WasedaTe.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(?:ELCL|NELCL|ECL|NER|ERCR4|ERCR|NEL|EL|ER|E|ER4|NEF|EP)$/, "R");
};
...
WasedaSho.prototype.setPaths = function() {
  ...
  switch (_head) {
    ...
    case "SW":
      this.dp = p(6.06715, -3.3913);
      this.paths = ["m 0 0 c 4.0576 -2.2492 12.3379 -6.1301 11.4288 -9.9348 c -0.6909 -2.8913 -2.5089 -0.1778 -3.4341 1.8126 c -0.8204 1.765 -1.23148 3.3117 -1.92756 4.7309"];
      return;
  }
...
WasedaOneLong.prototype.setPaths = function() {
  ...
  this.paths = ["m 0 0 l -8.99651 15.1121", "m -5.21372 12.7068 v 0"];
};

WasedaEight = function() { WasedaChar.call(this, "WasedaEight", "８", "8", "NWL", "NEL", "black", false, p(3.0, -0.7)); };
...
WasedaEight.prototype.setPaths = function() {
  ...
  this.dp = p(-0.016254, -0.37969);
  this.paths = ["m 0 0 c 0 -0.89855 -0.255031 -1.67686 -0.900256 -2.05491 c -0.316336 -0.18534 -0.867672 -0.18043 -1.09464 0.10751 c -0.869052 1.10251 0.960189 2.82058 0.57868 4.1716 c -0.170411 0.60347 -0.569193 1.49333 -1.19496 1.45293 c -0.238287 -0.0154 -0.48729 -0.3938 -0.380116 -0.60718 c 0.213431 -0.42493 2.37372 -3.13306 2.97503 -3.44964"];
};
