...
WasedaTa.prototype.toReverse = function() {
  return /^(SWR|SW|SR|S|SER|SWRCR)$/.test(this.getPrevTailType());
};
...
WasedaKu.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    ...
    case "SWR16":
      ...
      this.paths = ["m 0 0 c 2.132 -0.0745 4.26604 -0.038241 6.4 0 c 2.02328 0.036258 -0.540444 -4.39531 -2.23692 -3.41584 c -0.85175 0.49176 -0.274044 1.5961 -0.274044 3.36256"];
      return;
  }
...
WasedaShi.prototype.getFilteredPrevTail = function() {
  return this.getPrevTailType().replace(/^(?:ELCL4|NELCL4|ECL4|SERCL4|ECL|NE|E|SEL4)$/, "R");
};
...
WasedaShi.prototype.setPaths = function() {
  ...
  switch (this.getFilteredPrevTail() + "_" + _headModel) {
    case "R_ER8":
  ...
  switch (this.getFilteredPrevTail() + "_" + _head) {
    case "SEL_E":
  ...
  switch (this.getFilteredPrevTail()) {
    case "SEL":
...
WasedaSu.prototype.getFilteredPrevTail = WasedaShi.prototype.getFilteredPrevTail;
WasedaSu.prototype.setPaths = function() {
  //const name_ = this.getPrevName();
  const model_ = this.getPrevModel();
  //const tailModel_ = this.getPrevTailModel();
  const tail_ = this.getFilteredPrevTail();
  //const _name = this.getNextName();
  const _model = this.getNextModel();
  const _headModel = this.getNextHeadModel();
  const _head = this.getNextHeadType();
...
WasedaTo.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(?:SELCL4|E|ER|ER4|ERCR|ERCR4|EL|ECL|NELCL|NEL|NE|SELCL)$/, "R");
};
...
WasedaKei.prototype.setPaths = function() {
  ...
  switch (_head) {
    case "SEL":
      this.dp = p(2.83239, -6e-06);
      this.paths = ["m 0 0 l 3.53239 -6e-06 c 0.58408 -1e-06 0.63639 -0.845 0.07135 -0.9192 c -0.46945 -0.0617 -0.77135 0.460326 -0.77135 0.9192"];
      return;
...
WasedaHei.prototype.setPaths = function() {
  ...
  switch (_head) {
   case "E":
     ...
     this.paths = ["m 0 0 c 0 1.47086 0.567464 2.96485 1.73322 2.96485 c 0.3919 0 0.785797 -0.344344 0.785797 -0.559304 c 0 -0.344514 -0.136906 -0.713363 -0.42454 -0.770642 c -0.296091 -0.058963 -0.781514 0.272653 -0.707587 0.565368 c 0.093914 0.371852 0.722933 0.205274 1.13213 0.205274"];
     return;
...
WasedaRei.prototype.setPaths = function() {
  ...
  switch (_head) {
   ...
   case "E":
     ...
     this.paths = ["m 0 0 c 1.13193 0.793 2.39846 2.04701 1.9367 2.8468 c -0.331835 0.574754 -0.947253 0.054505 -0.94831 -0.27458 c -0.001142 -0.355767 0.454725 -0.30342 1.02327 -0.30342"];
     return;
  }
