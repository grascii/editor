...
WasedaTa = function() { WasedaChar.call(this, "WasedaTa", "た", "SW8/NE8", "SW/NE", "SW/NE", "black", false, p(2.9, -3.3)); };
...
WasedaSa.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(NELCL4|ECL4|ECL|E|NE|NER)$/, "R");
};
...
WasedaKi.prototype.setPaths = function() {
  switch (this.getNextHeadModel()) {
    ...
    case "EL4":
      this.dp = p(7.83349, 0.008268);
      this.paths = ["m 0 0 h 7.5 c 0.58408 0 0.651475 -0.78789 0.388795 -1.05539 c -0.260579 -0.265359 -1.00287 -0.00182 -1.05379 0.366591 c -0.055574 0.402086 0.655396 0.514629 0.998478 0.697067"];
      return;
    ...
    case "SER8":
      this.dp = p(6.8, -0);
      this.paths = ["m 0 0 h 7.5 c 0.574732 0 0.328935 -0.643224 0.037754 -0.870573 c -0.362256 -0.282843 -0.919091 -0.194793 -1.06421 -0.102179 c -0.288314 0.183998 -0.324933 0.516637 0.326459 0.972752"];
      return;
...
WasedaKu.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    ...
    case "SWR8":
    case "SWR16":
      this.dp = p(3.88904, -0.05328);
      this.paths = ["m 0 0 c 2.132 -0.0745 4.26604 -0.038241 6.4 0 c 2.02328 0.036258 -0.540441 -4.3953 -2.23692 -3.41584 c -1.05369 0.608351 -0.274044 1.5961 -0.274044 3.36256"];
      return;
  }
  ...
  switch (_head) {
    ...
    case "SW":
      this.dp = p(3.88904, -0.053282);
      this.paths = ["m 0 0 c 2.132 -0.0745 4.267 -0.0745 6.4 0 c 1.847 0.0645 0.420474 -2.44336 -0.452991 -2.66587 c -1.07428 -0.273675 -1.74268 1.74636 -2.05797 2.61259"];
      return;
...
WasedaNe.prototype.setPaths = function() {
  switch (this.getNextHeadModel()) {
    ...
    case "EL8":
      ...
      this.paths = ["m 0 0 c 2.881 0.56 15.881 2.746 15.881 0 c 0 -0.211 -0.003 -0.511964 -0.182 -0.646362 c -0.25206 -0.189262 -0.588815 -0.348995 -0.945585 0.007775 c -0.424717 0.424716 0.263158 0.652977 1.0828 0.90355"];
      return;
  }
...
WasedaShi.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(?:ELCL4|NELCL4|ECL4|SERCL4|ECL|NE|E)$/, "R");
};
...
WasedaShi.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    ...
    case "NEL8":
      ...
      this.paths = ["m 0 0 c 2.0364 -1.1288 5.7358 -2.6844 5.7358 -4.986 c 0 -0.610686 -0.467534 -0.332436 -0.822417 0.104487 c -0.258376 0.318105 -0.457038 0.720319 -0.372084 0.924818 c 0.128317 0.308879 0.458674 0.270288 1.0005 -0.076405"];
      return;
  }
...
WasedaSu.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(?:E)$/, "R");
};
WasedaSu.prototype.setPaths = function() {
  ...
  switch (tail_) {
    case "E":
      this.dp = p(-0.874496, 4.08031);
      this.paths = ["m 0 0 c 0 3.21345 -1.96809 7.09344 -3.84679 6.92264 c -2.27958 -0.207237 1.8716 -2.54741 2.97229 -2.84234"];
      this.reverse();
      return;
  ...
  switch (_head) {
    ...
    case "SW":
      this.dp = p(3.03357, -1.69564);
      this.paths = ["m 0 0 c 2.0288 -1.1246 6.16895 -3.06506 5.7144 -4.9674 c -0.345429 -1.44565 -1.25447 -0.088886 -1.71704 0.906285 c -0.410207 0.882508 -0.615746 1.65589 -0.963786 2.36548"];
      return;
...
WasedaSe.prototype.filterReverseTail = function(tail) {
...
WasedaSe.prototype.setPaths = function() {
  ...
  switch (_head) {
    case "E":
      ...
      this.paths = ["m 0 0 c 3.0001 -1.8027 11.4445 -6.7149 11.4445 -9.9485 c 0 -1.0469 -1.59372 0.01223 -1.56885 0.567822 c 0.021067 0.470618 0.697798 0.360318 1.36656 0.360318"];
      return;
...
WasedaHu.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    case "SW8":
      this.dp = p(1.13864, 4.93499);
      this.paths = ["m 0 0 c 0 1.8741 0.2905 3.3309 0.7678 4.3545 c 0.4951 1.0151 1.3611 1.5004 2.7067 1.5004 c 0.6304 0 1.22488 -0.231572 1.3022 -0.7218 c 0.155566 -0.986318 -1.04802 -2.22656 -2.0458 -2.18813 c -0.848915 0.032689 -1.09557 0.561082 -1.59227 1.99003"];
      return;
...
WasedaRi.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    ...
    case "EL8":
      this.dp = p(4.26922, 5.11406);
      this.paths = ["m 0 0 c 1.8914 1.3243 4.3722 3.7473 4.3371 5.7555 c 0 0.629014 -0.528837 0.388046 -0.775865 0.221328 c -0.289147 -0.195144 -0.616167 -0.545551 -0.463091 -0.819411 c 0.190591 -0.340975 0.764052 -0.175612 1.17108 -0.043357"];
      return;
  ...
  switch (_head) {
    ...
    case "S":
      this.dp = p(3.83285, 6.41998);
      this.paths = ["m 0 0 c 1.8914 1.3243 4.3722 3.7473 4.3371 5.7555 c 0 0.638571 -0.825327 0.86559 -1.14948 0.638283 c -0.1279 -0.089688 -0.317398 -0.298154 -0.198748 -0.74096 c 0.096731 -0.361007 0.819481 -0.679754 0.852956 0.036744 c 0.013262 0.283862 0.00486 0.261155 -0.00898 0.730415"];
      return;

    case "SE":
      this.dp = p(4.26922, 5.11406);
      this.paths = ["m 0 0 c 1.8914 1.3243 4.3722 3.7473 4.3371 5.7555 c 0 0.758139 -0.802551 0.435647 -1.11239 0.034288 c -0.214268 -0.277557 -0.351639 -0.81547 -0.054596 -1.00179 c 0.213056 -0.133636 0.661083 -0.111957 1.09911 0.326062"];
      return;
  }
...
WasedaRu.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    case "ER4":
      ...
      this.paths = ["m 0 0 c 1.907 1.2863 5.4379 4.63748 3.70052 6.37486 c -1.01508 1.01508 -2.50089 0.301321 -2.20866 -0.757836 c 0.242551 -0.879084 1.29681 -2.03324 1.88656 -2.37374"];
      return;
...
WasedaTo.prototype.filterReverseTail = function(tail) {
  return tail.replace(/^(?:SELCL4|E|ER|ER4|ERCR|ERCR4|EL|ECL|NELCL|NEL|NE)$/, "R");
};
...
WasedaAi.prototype.setPaths = function() {
  ...
  this.dp = p(0, 1.4e-05);
  this.paths = ["m 0 0 c -1.05896 -0.295582 -1.63769 -1.22576 -1.39536 -2.23831 c 0.242336 -1.01255 1.26819 -1.89952 2.25477 -1.83503 c 0.986574 0.064472 1.71532 0.498592 1.78371 1.85806 c 0.068394 1.35946 -0.861887 2.21529 -2.64311 2.21529"];
};
...
WasedaTsu.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    ...
    case "ER8":
      this.dp = p(0, 2.99114);
      this.paths = ["m 0 0 c 0 1.3336 0 2.65895 0 4 c 0 0.565945 -0.567037 0.8732 -0.9 0.5588 c -0.59069 -0.5576 0.559666 -0.978163 0.9 -1.56766"];
      return;
  ...
  case "SER8":
    ...
    case "EL8":
      this.dp = p(0, 3.69424);
      this.paths = ["m 0 0 v 4 c 0 0.273546 -0.337487 0.360033 -0.550099 0.332925 c -0.322151 -0.041074 -0.813523 -0.401295 -0.68027 -0.697457 c 0.168472 -0.374435 0.789227 -0.084576 1.23037 0.058769"];
      return;
  ...
  switch (_head) {
    case "E":
      this.dp = p(0, 3.47802);
      this.paths = ["m 0 0 v 4 c 0 0.79209 -1.14634 0.276059 -1.19101 -0.120459 c -0.046901 -0.416323 0.45875 -0.401525 1.19101 -0.401525"];
      return;
...
WasedaYu.prototype.setPaths = function() {
  ...
  switch (_headModel) {
    ...
    case "SER8":
      this.dp = p(6.6539, -4.15077);
      this.paths = ["m 0 0 c 0.9622 -2.5068 3.5566 -4.997 6.1707 -4.997 c 0.2753 0 0.658141 0.040574 0.778597 0.251665 c 0.166217 0.291289 -0.399321 0.986254 -0.84793 1.09368 c -0.381382 0.091323 -1.15002 -0.119863 -1.06381 -0.502432 c 0.118444 -0.525601 0.807639 -0.476603 1.61634 0.00332"];
      return;
  }
...
WasedaChi = function() { WasedaChar.call(this, "WasedaChi", "ち", "SW8CR1", "SW", "CR", "black", false, p(2.9, -3.3)); };
...
WasedaTe = function() { WasedaChar.call(this, "WasedaTe", "て", "NE16CL1", "NE", "CL", "black", false, p(0.0, 5.9)); };
...
switch (this.filterReverseTail(tail_)) {
  ...
  switch (_headModel) {
    ...
    case "NEL8":
      this.dp = p(9.82335, -10.56);
      this.paths = ["m 0 0 c 3.27921 -3.75924 6.69605 -7.43365 10.1917 -10.9293 c 0.284296 -0.284296 0.281278 -0.558693 0.09601 -0.708729 c -0.294914 -0.238832 -0.976442 0.01666 -1.07177 0.383985 c -0.077227 0.297578 0.085826 0.971341 0.607415 0.694042"];
      return;
  ...
  switch (_head) {
    ...
    case "E":
      this.dp = p(9.44089, -11.3614);
      this.paths = ["m 0 0 c 3.18352 -3.82759 6.43506 -8.36185 9.85983 -11.7866 c 0.283896 -0.283896 0.077257 -0.633311 -0.152338 -0.712375 c -0.457537 -0.157558 -1.22321 0.460448 -1.11329 0.931704 c 0.065978 0.282858 0.457099 0.205871 0.846686 0.205871"];
      return;
...
WasedaKan = function() { WasedaChar.call(this, "WasedaKan", "か", "E8NE1F", "E", "NEF", "black", false, p(0.0, 1.4)); };
...
WasedaTan.prototype.setPaths = function() {
  ...
  this.paths = ["m 0 0 l -2.73616 7.5176 l 1.06066 -1.06066", "m -0.170556 5.1128 v 0"];
};
...
WasedaThree = function() { WasedaChar.call(this, "WasedaThree", "３", "UER3UER3", "UER", "UER", "black", false, p(0.2, -2.9)); };
...
WasedaThree.prototype.setPaths = function() {
  ...
  this.dp = p(-0.193945, 5.58419);
  this.paths = ["m 0 0 c 0.876425 -0.438213 2.26419 -0.67174 2.64325 0.124718 c 0.379561 0.797497 0.08868 1.46443 -1.57217 2.13281 c 1.868 0.317857 1.58799 1.44142 1.11276 2.04292 c -0.535515 0.677807 -1.54506 1.28374 -2.37779 1.28374"];
};
...
WasedaNen.prototype.setPaths = function() {
  ...
  this.dp = p(19.2196, 0.373943);
  this.paths = ["m 0 0 c 2.87017 0.558 15.8213 2.735 15.8213 0 c 0 -0.343 -0.30605 -0.63581 -0.6056 -0.6735 c -0.419686 -0.0528 -1.1064 0.291 -1.0558 0.704 c 0.06 0.488 1.01544 0.36978 1.55222 0.36978 l 1.50769 -7e-06"];
};
...
WasedaHai = function() { WasedaChar.call(this, "WasedaHai", "はい", "SEL4", "SEL", "SEL", "black", false, p(0.0, -1.5)); };
...
WasedaNai.prototype.setPaths = function() {
  ...
  this.dp = p(3.99784, -9e-06);
  this.paths = ["m 0 0 c 0.187774 0.700781 0.819152 2.14169 1.99892 2.14169 c 1.17976 0 1.81185 -0.981099 1.99892 -2.1417"];
};
...
WasedaMai.prototype.setPaths = function() {
  ...
  this.dp = p(-3.99752, 0.000299);
  this.paths = ["m 0 0 c -0.03603 -0.673236 -1.0993 -2.17906 -1.99597 -2.23049 c -0.896674 -0.05143 -1.82754 1.507 -2.00155 2.23079"];
};
...
WasedaRai = function() { WasedaChar.call(this, "WasedaRai", "らい", "SER4", "SER", "SER", "black", false, p(2.8, 1.4)); };
